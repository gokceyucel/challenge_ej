...
export function AuthService($location, $http, $cookies, $q, appConfig, Util, UserResource) {
  'ngInject';
   ...
   */
  let hasRole = function (userRole, role) {
  ...
  let Auth = {
    ...
    createUser(user, callback) {
      return UserResource.save(user, function (data) {
